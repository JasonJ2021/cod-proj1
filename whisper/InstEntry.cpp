...
/* INSERT YOUR CODE FROM HERE */
	...
	OperandType::IntReg, OperandMode::Read, rs2Mask },
      ...
      { "rotleft", InstId::rotleft, 0b000011'0'00000'00000'001'00000'0100111, top7Funct3Low7Mask,
	InstType::Int,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::IntReg, OperandMode::Read, rs1Mask,
	OperandType::IntReg, OperandMode::Read, rs2Mask },
      { "rotright", InstId::rotright, 0b000011'0'00000'00000'010'00000'0100111, top7Funct3Low7Mask,
	InstType::Int,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::IntReg, OperandMode::Read, rs1Mask,
	OperandType::IntReg, OperandMode::Read, rs2Mask },

      { "reverse", InstId::reverse, 0b000011'0'00000'00000'011'00000'0100111, top7Funct3Low7Mask,
	InstType::Int,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::IntReg, OperandMode::Read, rs1Mask,
	OperandType::IntReg, OperandMode::Read, rs2Mask },
      { "notand", InstId::notand, 0b000011'0'00000'00000'100'00000'0100111, top7Funct3Low7Mask,
	InstType::Int,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::IntReg, OperandMode::Read, rs1Mask,
	OperandType::IntReg, OperandMode::Read, rs2Mask },
